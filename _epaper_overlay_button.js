...
(function(root) {
   ...
   */
  root.EPaperOverlayButton = function (a_epaper, a_image, a_handler) {
  ...
  root.EPaperOverlayButton.prototype = Object.create(EPaperWidget.prototype, {
    constructor: {
      configurable: true,
      enumarable: true,
   ...
   */
  root.EPaperOverlayButton.COMBO_CLOSE  = undefined;
  root.EPaperOverlayButton.COMBO_OPEN   = undefined;
  root.EPaperOverlayButton.COMBO_EDIT   = undefined;
  root.EPaperOverlayButton.COMBO_DELETE = undefined;
  root.EPaperOverlayButton.MENU_ADD     = undefined;
  root.EPaperOverlayButton.MENU_DELETE  = undefined;
  root.EPaperOverlayButton.MENU_CLOSE   = undefined;
   ...
   */
  root.EPaperOverlayButton.load_assets = function (a_epaper, asset_debug, a_asset_url, a_digest) {
    var suffix;
   ...
   * @return "das" widget
   */
  root.EPaperOverlayButton.prototype.set_image = function (a_image) {
   ...
   */
  root.EPaperOverlayButton.prototype.update_graphic = function () {
  ...
  root.EPaperOverlayButton.prototype.paint = function () {
